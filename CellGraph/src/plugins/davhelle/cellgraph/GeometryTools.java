...
public final class GeometryTools
{
  ...
  /**
   * Find the z-component of the cross-product of three points. P0 is center point
   * 
   * @param p0, p1, p2  Three points finding angle between [x,y,z].
   * @return            Z-component of the resulting Cross-product
   */
   ...
   * @return        Dot product of given vectors.
   */
  public static double computeDotProduct2D (double[] v0, double[] v1)
  {
  ...
  /**
   * Construct the vector specified by two points. in 2D
   * 
   * @param  p0, p1  Points the construct vector between [x,y,z].
   * @return v       Vector from p0 to p1 [x,y,z].
   */
  public static double[] createVector2D (double[] p0, double[] p1)
  {
