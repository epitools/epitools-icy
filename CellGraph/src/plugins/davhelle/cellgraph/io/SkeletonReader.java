...
public class SkeletonReader {
	 ...
	 */
	public SkeletonReader(String file_name, boolean redo_skeleton, SegmentationProgram tool){
		...
		if(redo_skeleton)
			raw_img = reskeletonize(file_name, tool);
	...
	private BufferedImage reskeletonize(String file_name,
		...
		if(tool == SegmentationProgram.MatlabLabelOutlines){
		...
		if(tool == SegmentationProgram.SeedWater){
